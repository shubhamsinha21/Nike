  ...
  return (
    <section className='flex justify-center items-center max-container gap-10 max-xl:flex-col-reverse'>
      <div className='drop-shadow-lg'>
        ...
        className='w-700 h-600 object-contain'/>
      </div>
